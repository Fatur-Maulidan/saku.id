...
public class MyAdapterPendapatan extends RecyclerView.Adapter<MyAdapterPendapatan.MyViewHolder> {
    ...
    public MyAdapterPendapatan(Context context, ArrayList catatan, ArrayList nominal, ArrayList tanggal) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_row_pendapatan,parent,false);
